...
const App = () => {
  ...
  useEffect(() => {
    ...
    fetch('http://workoutapp.club/api/account/checkLoginStatus').then(res => {
  ...
  useEffect(() => {
    const getRoutines = async () => {
      const routines = await fetch("http://workoutapp.club/api/routines");
  ...
  useEffect(() => {
    const getExercisesRoutines = async () => {
      const exercisesRoutines = await fetch("http://workoutapp.club/api/routines/exercises");
  ...
  useEffect(() => {
    const getExercises = async () => {
      const exercises = await fetch("http://workoutapp.club/api/exercises");
